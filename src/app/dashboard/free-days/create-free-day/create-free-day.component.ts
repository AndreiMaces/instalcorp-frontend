...
export class CreateFreeDayComponent {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: { day: Date }
  ) {
  }
    ...
    this.dialog
      .open(ConfirmationDialogComponent, {
        ...
        data: {
          title: "Atenție!!!",
          message:
            "<span class=\"text-red-500 underline\">Toate sarcinile care conțin intervalul înregistrat vor fi  modificate după caz.</span> <span>Doriți să continuați?</span>"
        }
      })
      .afterClosed()
      .subscribe((result) => {
