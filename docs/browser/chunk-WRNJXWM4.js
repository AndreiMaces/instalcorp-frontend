import { a as We, e as kn, g as Sn, h as An, j as vi, k as ie } from "./chunk-C3VSF42U.js";
import { c as Lt, d as It, f as ct, g as xt, h as kt } from "./chunk-WXI33M2S.js";
import {
  $ as v,
  $b as Yt,
  _b as G,
...
var N = (() => {
  let e = class e {
    constructor(t) {
      (this._platformId = t),
        (this.isBrowser = this._platformId ? In(this._platformId) : typeof document == "object" && !!document),
        (this.EDGE = this.isBrowser && /(edge)/i.test(navigator.userAgent)),
        (this.TRIDENT = this.isBrowser && /(msie|trident)/i.test(navigator.userAgent)),
        (this.BLINK = this.isBrowser && !!(window.chrome || wi) && typeof CSS < "u" && !this.EDGE && !this.TRIDENT),
...
function $e() {
  if ($t == null) {
    ...
    if ("scrollBehavior" in document.documentElement.style) $t = !0;
    else {
...
function ne() {
  ...
  if (Ye == null) {
    ...
    (t.width = "2px"),
      ...
      (Ye = Ct.NORMAL),
      o.scrollLeft === 0 && ((o.scrollLeft = 1), (Ye = o.scrollLeft === 0 ? Ct.NEGATED : Ct.INVERTED)),
      o.remove();
  }
  return Ye;
}
...
var Ci = class {
  constructor(e, r) {
    (this._items = e),
      ...
      (this._wrap = !1),
      (this._letterKeyStream = new g()),
      (this._typeaheadSubscription = it.EMPTY),
      (this._vertical = !0),
      ...
      (this.change = new g()),
      e instanceof Ft
        ? (this._itemChangesSubscription = e.changes.subscribe((t) => this._itemsChanged(t.toArray())))
        : fi(e) && (this._effectRef = xn(() => this._itemsChanged(e()), { injector: r }));
  }
  ...
  withTypeAhead(e = 200) {
    return (
      ...
      (this._typeaheadSubscription = this._letterKeyStream
        .pipe(
          te((r) => this._pressedLetters.push(r)),
          je(e),
          M(() => this._pressedLetters.length > 0),
          vt(() => this._pressedLetters.join("")),
        )
        .subscribe((r) => {
          let t = this._getItemsArray();
          for (let i = 1; i < t.length + 1; i++) {
            let n = (this._activeItemIndex + i) % t.length,
              a = t[n];
      ...
      default:
        (i || gt(e, "shiftKey")) &&
          (e.key && e.key.length === 1
            ...
            : ((r >= 65 && r <= 90) || (r >= 48 && r <= 57)) && this._letterKeyStream.next(String.fromCharCode(r)));
        return;
    }
  ...
  updateActiveItem(e) {
    let r = this._getItemsArray(),
      t = typeof e == "number" ? e : r.indexOf(e),
      i = r[t];
  ...
  _setActiveInWrapMode(e) {
    ...
    for (let t = 1; t <= r.length; t++) {
      let i = (this._activeItemIndex + e * t + r.length) % r.length,
        n = r[i];
  ...
  let e = class e {
    ...
    isTabbable(t) {
      ...
      return t.hasAttribute("contenteditable")
        ? a !== -1
        : n === "iframe" || n === "object" || (this._platform.WEBKIT && this._platform.IOS && !ur(t))
          ? !1
          : n === "audio"
...
var gr = new v("cdk-input-modality-detector-options"),
  br = { ignoreKeys: [18, 17, 224, 91, 16] },
  Fn = 650,
  ae = Bt({ passive: !0, capture: !0 }),
  _r = (() => {
    let e = class e {
      ...
      constructor(t, i, n, a) {
        (this._platform = t),
          ...
          (this._options = w(w({}, br), a)),
          (this.modalityDetected = this._modality.pipe(ln(1))),
          (this.modalityChanged = this.modalityDetected.pipe(fe())),
          t.isBrowser &&
            i.runOutsideAngular(() => {
              n.addEventListener("keydown", this._onKeydown, ae),
                n.addEventListener("mousedown", this._onMousedown, ae),
                n.addEventListener("touchstart", this._onTouchstart, ae);
            });
      }
      ...
      ngOnDestroy() {
        this._modality.complete(),
          this._platform.isBrowser &&
            (document.removeEventListener("keydown", this._onKeydown, ae),
            document.removeEventListener("mousedown", this._onMousedown, ae),
            document.removeEventListener("touchstart", this._onTouchstart, ae));
      }
    };
    (e.ɵfac = function (i) {
...
var Xe = (function (o) {
  ...
  vr = new v("cdk-focus-monitor-default-options"),
  Ge = Bt({ passive: !0, capture: !0 }),
  mt = (() => {
    let e = class e {
      ...
      focusVia(t, i, n) {
        ...
        a === s
          ? this._getClosestElementsInfo(a).forEach(([c, u]) => this._originChanged(c, i, u))
      ...
      _onBlur(t, i) {
        let n = this._elementInfo.get(i);
        !n ||
          (n.checkChildren && t.relatedTarget instanceof Node && i.contains(t.relatedTarget)) ||
      ...
      _registerGlobalListeners(t) {
        ...
        n ||
          this._ngZone.runOutsideAngular(() => {
            i.addEventListener("focus", this._rootNodeFocusAndBlurListener, Ge),
              i.addEventListener("blur", this._rootNodeFocusAndBlurListener, Ge);
          }),
      ...
      _removeGlobalListeners(t) {
        ...
        if (this._rootNodeFocusListenerCount.has(i)) {
          ...
          n > 1
            ? this._rootNodeFocusListenerCount.set(i, n - 1)
            : (i.removeEventListener("focus", this._rootNodeFocusAndBlurListener, Ge),
              i.removeEventListener("blur", this._rootNodeFocusAndBlurListener, Ge),
    ...
    constructor(t) {
      if (((this.value = "ltr"), (this.change = new F()), t)) {
        let i = t.body ? t.body.dir : null,
          n = t.documentElement ? t.documentElement.dir : null;
...
var bt = (function (o) {
    return (
      (o[(o.FADING_IN = 0)] = "FADING_IN"),
      (o[(o.VISIBLE = 1)] = "VISIBLE"),
      (o[(o.FADING_OUT = 2)] = "FADING_OUT"),
      (o[(o.HIDDEN = 3)] = "HIDDEN"),
      o
    );
  })(bt || {}),
  ...
  Mi = class {
    constructor() {
      (this._events = new Map()),
        (this._delegateEventHandler = (e) => {
          let r = ft(e);
          r &&
            this._events.get(e.type)?.forEach((t, i) => {
    ...
    addHandler(e, r, t, i) {
      ...
      if (n) {
        ...
        this._events.set(r, new Map([[t, new Set([i])]])),
          e.runOutsideAngular(() => {
    ...
    removeHandler(e, r, t) {
      ...
      n &&
        (n.delete(t),
        n.size === 0 && i.delete(r),
        i.size === 0 && (this._events.delete(e), document.removeEventListener(e, this._delegateEventHandler, Pn)));
    }
  },
  jn = { enterDuration: 225, exitDuration: 150 },
  Er = 800,
  Nn = Bt({ passive: !0, capture: !0 }),
  ...
  xe = class xe {
    constructor(e, r, t, i) {
      (this._target = e),
        ...
        i.isBrowser && (this._containerElement = Tt(t));
    }
    ...
    fadeInRipple(e, r, t = {}) {
      ...
      l.classList.add("mat-ripple-element"),
        ...
        t.color != null && (l.style.backgroundColor = t.color),
        (l.style.transitionDuration = `${u}ms`),
        this._containerElement.appendChild(l);
      let m = window.getComputedStyle(l),
        D = m.transitionProperty,
        R = m.transitionDuration,
        B = D === "none" || R === "0s" || R === "0s, 0s" || (i.width === 0 && i.height === 0),
        q = new Ai(this, l, t, B);
        ...
        !B &&
          ...
          this._ngZone.runOutsideAngular(() => {
            let tn = () => {
              ...
              li = () => this._destroyRipple(q),
              en = setTimeout(li, u + 100);
            l.addEventListener("transitionend", tn),
              l.addEventListener("transitioncancel", li),
              (Vt = { onTransitionEnd: tn, onTransitionCancel: li, fallbackTimer: en });
          }),
        this._activeRipples.set(q, Vt),
        (B || !u) && this._finishRippleTransition(q),
        q
      );
    }
    ...
    fadeOutRipple(e) {
      ...
      let r = e.element,
        t = w(w({}, jn), e.config.animation);
      (r.style.transitionDuration = `${t.exitDuration}ms`),
        (r.style.opacity = "0"),
        (e.state = bt.FADING_OUT),
        (e._animationForciblyDisabledThroughCss || !t.exitDuration) && this._finishRippleTransition(e);
    }
    ...
    _onMousedown(e) {
      let r = ve(e),
        t = this._lastTouchStartEvent && Date.now() < this._lastTouchStartEvent + Er;
    ...
    _removeTriggerEvents() {
      ...
      e &&
        (Ln.forEach((r) => xe._eventManager.removeHandler(r, e, this)),
        this._pointerUpEventsRegistered && (Bn.forEach((r) => e.removeEventListener(r, this, Nn)), (this._pointerUpEventsRegistered = !1)));
    }
  };
...
var Un = new v("mat-ripple-global-options"),
  Ce = (() => {
    let e = class e {
      get disabled() {
      ...
      constructor(t, i, n, a, s) {
        (this._elementRef = t),
          ...
          (this._rippleRenderer = new Ti(this, i, t, n));
      }
      ...
      launch(t, i = 0, n) {
        return typeof t == "number"
          ? this._rippleRenderer.fadeInRipple(t, i, w(w({}, this.rippleConfig), n))
          : this._rippleRenderer.fadeInRipple(0, 0, w(w({}, this.rippleConfig), t));
      }
    };
    (e.ɵfac = function (i) {
...
var Vn = { capture: !0 },
  zn = ["focus", "mousedown", "mouseenter", "touchstart"],
  ki = "mat-ripple-loader-uninitialized",
  Si = "mat-ripple-loader-class-name",
  Hn = "mat-ripple-loader-centered",
  ti = "mat-ripple-loader-disabled",
  Wn = (() => {
    let e = class e {
      constructor() {
        (this._document = I(E, { optional: !0 })),
          (this._animationMode = I(J, { optional: !0 })),
          (this._globalRippleOptions = I(Un, { optional: !0 })),
          (this._platform = I(N)),
          (this._ngZone = I(k)),
          (this._hosts = new Map()),
      ...
      configureRipple(t, i) {
        t.setAttribute(ki, this._globalRippleOptions?.namespace ?? ""),
          (i.className || !t.hasAttribute(Si)) && t.setAttribute(Si, i.className || ""),
          i.centered && t.setAttribute(Hn, ""),
          i.disabled && t.setAttribute(ti, "");
      }
      ...
      _createRipple(t) {
        ...
        return (
          (a._isInitialized = !0),
          (a.trigger = t),
          (a.centered = t.hasAttribute(Hn)),
          (a.disabled = t.hasAttribute(ti)),
...
var Pr = [
    ...
    { attribute: "mat-mini-fab", mdcClasses: ["mdc-fab", "mat-mdc-fab-base", "mdc-fab--mini", "mat-mdc-mini-fab"] },
    ...
    let e = class e {
      ...
      constructor(t, i, n, a) {
        (this._elementRef = t),
          ...
          (this._focusMonitor = I(mt)),
          (this._rippleLoader = I(Wn)),
          (this._isFab = !1),
          (this._disableRipple = !1),
          (this._disabled = !1);
        let s = I(Fr, { optional: !0 }),
          c = t.nativeElement,
          u = c.classList;
        (this.disabledInteractive = s?.disabledInteractive ?? !1),
          (this.color = s?.color ?? null),
          this._rippleLoader?.configureRipple(c, { className: "mat-mdc-button-ripple" });
...
var ce = (() => {
  ...
  (e.ɵfac = function (i) {
    ...
    (e.ɵcmp = b({
      ...
      hostBindings: function (i, n) {
        i & 2 &&
          (T("disabled", n._getDisabledAttribute())("aria-disabled", n._getAriaDisabled()),
          At(n.color ? "mat-" + n.color : ""),
          L("mat-mdc-button-disabled", n.disabled)("mat-mdc-button-disabled-interactive", n.disabledInteractive)(
      ...
      template: function (i, n) {
        i & 1 && (et(Ar), P(0, "span", 0), O(1), p(2, "span", 1), O(3, 1), f(), O(4, 2), P(5, "span", 2)(6, "span", 3)),
          i & 2 && L("mdc-button__ripple", !n._isFab)("mdc-fab__ripple", n._isFab);
      },
      styles: [
    ...
    let e = class e {
      ...
      getSvgIconFromUrl(t) {
        ...
        return n
          ...
          : this._loadSvgIconFromConfig(new Rt(t, null)).pipe(
              te((a) => this._cachedIconsByUrl.set(i, a)),
              vt((a) => ni(a)),
            );
      }
        ...
        for (let n = i.length - 1; n >= 0; n--) {
          ...
          if (a.svgText && a.svgText.toString().indexOf(t) > -1) {
            let s = this._svgElementFromConfig(a),
              c = this._extractSvgIconFromSet(s, t, a.options);
            if (c) return c;
          }
        }
        return null;
      ...
      _loadSvgIconFromConfig(t) {
        return this._fetchIcon(t).pipe(
          te((i) => (t.svgText = i)),
          vt(() => this._svgElementFromConfig(t)),
        );
      }
      ...
      _toSvgElement(t) {
        let i = this._svgElementFromString(Ee("<svg></svg>")),
          n = t.attributes;
        ...
        for (let a = 0; a < t.childNodes.length; a++)
          t.childNodes[a].nodeType === this._document.ELEMENT_NODE && i.appendChild(t.childNodes[a].cloneNode(!0));
        return i;
      }
      ...
      _fetchIcon(t) {
        ...
        if (c) return c;
        let u = this._httpClient.get(s, { responseType: "text", withCredentials: a }).pipe(
          vt((l) => Ee(l)),
          cn(() => this._inProgressUrlFetches.delete(s)),
          dn(),
        );
...
var Hr = new v("MAT_ICON_DEFAULT_OPTIONS"),
  Ur = new v("mat-icon-location", { providedIn: "root", factory: Wr });
  ...
  de = (() => {
    let e = class e {
      ...
      constructor(t, i, n, a, s, c) {
        (this._elementRef = t),
          ...
          c && (c.color && (this.color = this._defaultColor = c.color), c.fontSet && (this.fontSet = c.fontSet)),
      ...
      _updateFontIconClasses() {
        ...
        let t = this._elementRef.nativeElement,
          i = (
            this.fontSet ? this._iconRegistry.classNameForFontAlias(this.fontSet).split(/ +/) : this._iconRegistry.getDefaultFontSetClass()
          ).filter((n) => n.length > 0);
    ...
    (e.ɵfac = function (i) {
      ...
      (e.ɵcmp = b({
        ...
        hostBindings: function (i, n) {
          i & 2 &&
            (T("data-mat-icon-type", n._usingFontIcon() ? "font" : "svg")("data-mat-icon-name", n._svgName || n.fontIcon)(
              "data-mat-icon-namespace",
              n._svgNamespace || n.fontSet,
            )("fontIcon", n._usingFontIcon() ? n.fontIcon : null),
            At(n.color ? "mat-" + n.color : ""),
            L("mat-icon-inline", n.inline)("mat-icon-no-color", n.color !== "primary" && n.color !== "accent" && n.color !== "warn"));
        },
        inputs: {
          color: "color",
...
var qn = (() => {
  class o {
    ...
    static ɵcmp = b({
      ...
      vars: 0,
      consts: [
        [1, "w-full", "border-b", "flex", "justify-between", "items-center", "px-5", "py-3"],
        ["mat-icon-button", "", 1, "flex", "items-center", "justify-center", 3, "click"],
        [1, "text-2xl"],
        [1, "text-md", "!m-0"],
      ],
      template: function (t, i) {
  ...
  De = (() => {
    let e = class e {
      ...
      getAncestorScrollContainers(t) {
        let i = [];
        return (
          this.scrollContainers.forEach((n, a) => {
    ...
    let e = class e {
      constructor(t, i, n, a) {
        (this.elementRef = t),
          ...
          (this._elementScrolled = new mi((s) =>
            this.ngZone.runOutsideAngular(() => pe(this.elementRef.nativeElement, "scroll").pipe(V(this._destroyed)).subscribe(s)),
          ));
      }
      ...
      scrollTo(t) {
        ...
        t.left == null && (t.left = n ? t.end : t.start),
          t.right == null && (t.right = n ? t.start : t.end),
          t.bottom != null && (t.top = i.scrollHeight - i.clientHeight - t.bottom),
          n && ne() != Ct.NORMAL
            ? (t.left != null && (t.right = i.scrollWidth - i.clientWidth - t.left),
              ne() == Ct.INVERTED ? (t.left = t.right) : ne() == Ct.NEGATED && (t.left = t.right ? -t.right : t.right))
            : t.right != null && (t.left = i.scrollWidth - i.clientWidth - t.right),
    ...
    let e = class e {
      ...
      getViewportRect() {
        let t = this.getViewportScrollPosition(),
          { width: i, height: n } = this.getViewportSize();
...
var eo = ["*"],
  Xr = ["content"],
  Kr = [[["mat-drawer"]], [["mat-drawer-content"]], "*"],
...
var ta = {
  transformDrawer: Lt("transform", [
    xt("open, open-instant", ct({ transform: "none", visibility: "visible" })),
    xt("void", ct({ "box-shadow": "none", visibility: "hidden" })),
    kt("void => open-instant", It("0ms")),
    kt("void <=> open, open-instant => void", It("400ms cubic-bezier(0.25, 0.8, 0.25, 1)")),
  ]),
};
var ea = new v("MAT_DRAWER_DEFAULT_AUTOSIZE", { providedIn: "root", factory: ia }),
  io = new v("MAT_DRAWER_CONTAINER");
  ...
  Oi = (() => {
    let e = class e {
      ...
      set position(t) {
        (t = t === "end" ? "end" : "start"),
          t !== this._position &&
            (this._isAttached && this._updatePositionInParent(t), (this._position = t), this.onPositionChanged.emit());
      }
      ...
      constructor(t, i, n, a, s, c, u, l) {
        (this._elementRef = t),
          ...
          (this._opened = !1),
          (this._animationStarted = new g()),
          (this._animationEnd = new g()),
          (this._animationState = "void"),
          (this.openedChange = new F(!0)),
          (this._openedStream = this.openedChange.pipe(
            M((m) => m),
            vt(() => {}),
          )),
          (this.openedStart = this._animationStarted.pipe(
            M((m) => m.fromState !== m.toState && m.toState.indexOf("open") === 0),
            ui(void 0),
          )),
          ...
          (this.closedStart = this._animationStarted.pipe(
            M((m) => m.fromState !== m.toState && m.toState === "void"),
            ui(void 0),
          )),
          (this._destroyed = new g()),
          (this.onPositionChanged = new F()),
          (this._modeChanged = new g()),
          (this._injector = I($)),
          (this._changeDetectorRef = I(Q)),
          this.openedChange.pipe(V(this._destroyed)).subscribe((m) => {
            m
              ? (this._doc && (this._elementFocusedBeforeDrawerWasOpened = this._doc.activeElement), this._takeFocus())
              : this._isFocusWithinDrawer() && this._restoreFocus(this._openedVia || "program");
          }),
          this._ngZone.runOutsideAngular(() => {
            pe(this._elementRef.nativeElement, "keydown")
              .pipe(
                M((m) => m.keyCode === 27 && !this.disableClose && !gt(m)),
                V(this._destroyed),
              )
              .subscribe((m) =>
                this._ngZone.run(() => {
          ...
          this._animationEnd.pipe(fe((m, D) => m.fromState === D.fromState && m.toState === D.toState)).subscribe((m) => {
            ...
            ((R.indexOf("open") === 0 && D === "void") || (R === "void" && D.indexOf("open") === 0)) &&
      ...
      _restoreFocus(t) {
        this.autoFocus !== "dialog" &&
          (this._elementFocusedBeforeDrawerWasOpened
            ? this._focusMonitor.focusVia(this._elementFocusedBeforeDrawerWasOpened, t)
      ...
      _setOpen(t, i, n) {
        return (
          ...
          t
            ...
            : ((this._animationState = "void"), i && this._restoreFocus(n)),
          this._changeDetectorRef.markForCheck(),
      ...
      _updatePositionInParent(t) {
        ...
        let i = this._elementRef.nativeElement,
          n = i.parentNode;
        t === "end"
          ? (this._anchor || ((this._anchor = this._doc.createComment("mat-drawer-anchor")), n.insertBefore(this._anchor, i)),
            n.appendChild(i))
          : this._anchor && this._anchor.parentNode.insertBefore(i, this._anchor);
      }
    };
    (e.ɵfac = function (i) {
      ...
      (e.ɵcmp = b({
        ...
        hostBindings: function (i, n) {
          i & 1 &&
            vn("@transform.start", function (s) {
              return n._animationStarted.next(s);
            })("@transform.done", function (s) {
              return n._animationEnd.next(s);
            }),
            i & 2 &&
              (_n("@transform", n._animationState),
              T("align", null),
              L("mat-drawer-end", n.position === "end")("mat-drawer-over", n.mode === "over")("mat-drawer-push", n.mode === "push")(
                "mat-drawer-side",
                n.mode === "side",
              )("mat-drawer-opened", n.opened));
        },
        inputs: {
          position: "position",
          mode: "mode",
  ...
  Fi = (() => {
    let e = class e {
      ...
      constructor(t, i, n, a, s, c = !1, u) {
        (this._dir = t),
          ...
          (this._drawers = new Ft()),
          (this.backdropClick = new F()),
          (this._destroyed = new g()),
          (this._doCheckSubject = new g()),
          (this._contentMargins = { left: null, right: null }),
          (this._contentMarginChanges = new g()),
          (this._injector = I($)),
          t &&
            t.change.pipe(V(this._destroyed)).subscribe(() => {
              this._validateDrawers(), this.updateContentMargins();
            }),
          s
            .change()
            .pipe(V(this._destroyed))
      ...
      updateContentMargins() {
        ...
        if (this._left && this._left.opened) {
          if (this._left.mode == "side") t += this._left._getWidth();
        ...
        (t = t || null),
          (i = i || null),
          (t !== this._contentMargins.left || i !== this._contentMargins.right) &&
      ...
      _watchDrawerToggle(t) {
        t._animationStarted
          .pipe(
            M((i) => i.fromState !== i.toState),
            V(this._drawers.changes),
          )
          .subscribe((i) => {
      ...
      _watchDrawerPosition(t) {
        t &&
          t.onPositionChanged.pipe(V(this._drawers.changes)).subscribe(() => {
            yt(
              () => {
                this._validateDrawers();
              },
      ...
      _watchDrawerMode(t) {
        t &&
          t._modeChanged.pipe(V(ht(this._drawers.changes, this._destroyed))).subscribe(() => {
      ...
      _isPushed() {
        return (
          (this._isDrawerOpen(this._start) && this._start.mode != "over") || (this._isDrawerOpen(this._end) && this._end.mode != "over")
        );
      }
      ...
      _closeModalDrawersViaBackdrop() {
        [this._start, this._end]
          .filter((t) => t && !t.disableClose && this._drawerHasBackdrop(t))
    ...
    (e.ɵfac = function (i) {
      ...
      (e.ɵcmp = b({
        ...
        template: function (i, n) {
          i & 1 && (et(Kr), K(0, qr, 1, 2, "div", 0), O(1), O(2, 1), K(3, Jr, 2, 0, "mat-drawer-content")),
            i & 2 && (jt(n.hasBackdrop ? 0 : -1), S(3), jt(n._content ? -1 : 3));
        },
        dependencies: [ke],
        styles: [
...
var no = (() => {
  class o {
    ...
    static ɵcmp = b({
      ...
      consts: [
        [1, "px-3", "py-5"],
        [1, "flex", "flex-col", "gap-5", "justify-center", "items-center"],
        [1, "w-[80px]", "h-[80px]", "bg-[#ccc]", "rounded-full"],
        [1, "flex", "flex-col", "justify-center", "items-center"],
        [1, "text-2xl", "!m-0"],
        [1, "text-md"],
        [1, "flex", "flex-col", "py-5"],
        [
          "routerLink",
          "calendar",
          "matRipple",
    ...
    class o {
      ...
      static ɵcmp = b({
        ...
        consts: [
          ["drawer", ""],
          ["mode", "over"],
          [1, "flex", "flex-col", "h-screen", "w-full"],
        ],
        template: function (t, i) {
          t & 1 &&
            (p(0, "mat-drawer-container")(1, "mat-drawer", 1, 0),
            P(3, "app-sidebar"),
            f(),
            p(4, "mat-drawer-content")(5, "div", 2),
            P(6, "app-navbar")(7, "router-outlet"),
            f()()());
        },
    ...
    let e = class e {
      ...
      constructor(t, i, n) {
        (this.accordion = t),
          ...
          (this._openCloseAllSubscription = it.EMPTY),
          (this.closed = new F()),
          (this.opened = new F()),
          (this.destroyed = new F()),
          (this.expandedChange = new F()),
          (this.id = `cdk-accordion-child-${oa++}`),
          (this._expanded = !1),
          (this.disabled = !1),
...
var Ae = class extends me {
  ...
  attachComponentPortal(e) {
    let t = (e.componentFactoryResolver || this._componentFactoryResolver).resolveComponentFactory(e.component),
      i;
    return (
      e.viewContainerRef
        ...
        : ((i = t.create(e.injector || this._defaultInjector || $.NULL)),
  ...
  attachTemplatePortal(e) {
    let r = e.viewContainerRef,
      t = r.createEmbeddedView(e.templateRef, e.context, { injector: e.injector });
    return (
      t.rootNodes.forEach((i) => this.outletElement.appendChild(i)),
      t.detectChanges(),
      this.setDisposeFn(() => {
        let i = r.indexOf(t);
        i !== -1 && r.remove(i);
...
var ra = ["body"],
  aa = [[["mat-expansion-panel-header"]], "*", [["mat-action-row"]]],
...
var so = new v("MAT_ACCORDION"),
  co = "225ms cubic-bezier(0.4,0.0,0.2,1)",
  mo = {
    indicatorRotate: Lt("indicatorRotate", [
      xt("collapsed, void", ct({ transform: "rotate(0deg)" })),
      xt("expanded", ct({ transform: "rotate(180deg)" })),
      kt("expanded <=> collapsed, void => collapsed", It(co)),
    ]),
    bodyExpansion: Lt("bodyExpansion", [
      xt("collapsed, void", ct({ height: "0px", visibility: "hidden" })),
      xt("expanded", ct({ height: "*", visibility: "" })),
      kt("expanded <=> collapsed, void => collapsed", It(co)),
    ]),
  },
  ho = new v("MAT_EXPANSION_PANEL"),
  ha = (() => {
    let e = class e {
      constructor(t, i) {
  ...
  ua = 0,
  uo = new v("MAT_EXPANSION_PANEL_DEFAULT_OPTIONS"),
  Bi = (() => {
    let e = class e extends ao {
      ...
      constructor(t, i, n, a, s, c, u) {
        super(t, i, n),
          ...
          (this._hideToggle = !1),
          (this.afterExpand = new F()),
          (this.afterCollapse = new F()),
          (this._inputChanges = new g()),
          (this._headerId = `mat-expansion-panel-header-${ua++}`),
          (this.accordion = t),
          (this._document = s),
          (this._animationsDisabled = c === "NoopAnimations"),
          u && (this.hideToggle = u.hideToggle);
      }
      ...
      _containsFocus() {
        if (this._body) {
          let t = this._document.activeElement,
      ...
      _animationDone(t) {
        lo(t) ||
          (t.toState === "expanded" ? this.afterExpand.emit() : t.toState === "collapsed" && this.afterCollapse.emit(),
          !this._animationsDisabled && this._body && this._body.nativeElement.removeAttribute("inert"));
      }
    };
    (e.ɵfac = function (i) {
      ...
      (e.ɵcmp = b({
        ...
        hostBindings: function (i, n) {
          i & 2 &&
            L("mat-expanded", n.expanded)("_mat-animation-noopable", n._animationsDisabled)("mat-expansion-panel-spacing", n._hasSpacing());
        },
        ...
        features: [
          lt([
            { provide: so, useValue: void 0 },
            { provide: ho, useExisting: e },
          ]),
          tt,
          st,
          Ht,
        ...
        template: function (i, n) {
          if (i & 1) {
            ...
            et(aa),
              O(0),
              p(1, "div", 1, 0),
              j("@bodyExpansion.start", function (c) {
          ...
          i & 2 &&
            (S(),
            Z("@bodyExpansion", n._getExpandedState())("id", n.id),
            T("aria-labelledby", n._headerId),
            S(4),
            Z("cdkPortalOutlet", n._portal));
        },
        dependencies: [Kt],
        styles: [
  ...
  let e = class e {
    constructor(t, i, n, a, s, c, u) {
      (this.panel = t),
        ...
        (this._changeDetectorRef = a),
        (this._animationMode = c),
        (this._parentChangeSubscription = it.EMPTY),
        (this.tabIndex = 0);
      let l = t.accordion ? t.accordion._stateChanges.pipe(M((m) => !!(m.hideToggle || m.togglePosition))) : on;
      (this.tabIndex = parseInt(u || "") || 0),
        (this._parentChangeSubscription = ht(
          t.opened,
          t.closed,
          l,
          t._inputChanges.pipe(M((m) => !!(m.hideToggle || m.disabled || m.togglePosition))),
        ).subscribe(() => this._changeDetectorRef.markForCheck())),
        t.closed.pipe(M(() => t._containsFocus())).subscribe(() => n.focusVia(i, "program")),
    ...
    (e.ɵcmp = b({
      ...
      hostBindings: function (i, n) {
        i & 1 &&
          ...
          i & 2 &&
            (T("id", n.panel._headerId)("tabindex", n.disabled ? -1 : n.tabIndex)("aria-controls", n._getPanelId())(
              "aria-expanded",
              n._isExpanded(),
            )("aria-disabled", n.panel.disabled),
            wt("height", n._getHeaderHeight()),
            L("mat-expanded", n._isExpanded())("mat-expansion-toggle-indicator-after", n._getTogglePosition() === "after")(
              "mat-expansion-toggle-indicator-before",
              n._getTogglePosition() === "before",
      ...
      consts: [
        ...
        ["xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 -960 960 960", "aria-hidden", "true", "focusable", "false"],
        ["d", "M480-345 240-585l56-56 184 184 184-184 56 56-240 240Z"],
      ],
      template: function (i, n) {
        i & 1 && (et(da), p(0, "span", 0), O(1), O(2, 1), O(3, 2), f(), K(4, ma, 3, 1, "span", 1)),
          i & 2 && (L("mat-content-hide-toggle", !n._showToggle()), S(4), jt(n._showToggle() ? 4 : -1));
      },
      styles: [
    ...
    enable() {
      if (this._canBeEnabled()) {
        ...
        (this._previousScrollPosition = this._viewportRuler.getViewportScrollPosition()),
          ...
          (e.style.left = U(-this._previousScrollPosition.left)),
          (e.style.top = U(-this._previousScrollPosition.top)),
    ...
    disable() {
      if (this._isEnabled) {
        ...
        (this._isEnabled = !1),
          ...
          go && (t.scrollBehavior = i.scrollBehavior = "auto"),
          window.scroll(this._previousScrollPosition.left, this._previousScrollPosition.top),
          go && ((t.scrollBehavior = n), (i.scrollBehavior = a));
      }
    }
...
var zi = class {
    ...
    enable() {
      ...
      let e = this._scrollDispatcher
        .scrolled(0)
        .pipe(M((r) => !r || !this._overlayRef.overlayElement.contains(r.getElementRef().nativeElement)));
        ...
        this._scrollSubscription = this._scrollDispatcher.scrolled(e).subscribe(() => {
          if ((this._overlayRef.updatePosition(), this._config && this._config.autoClose)) {
            let r = this._overlayRef.overlayElement.getBoundingClientRect(),
              { width: t, height: i } = this._viewportRuler.getViewportSize();
            Hi(r, [{ width: t, height: i, bottom: i, right: t, top: 0, left: 0 }]) &&
    ...
    let e = class e {
      constructor(t, i, n, a) {
        (this._scrollDispatcher = t),
          ...
          (this._ngZone = n),
          (this.noop = () => new ai()),
          (this.close = (s) => new zi(this._scrollDispatcher, this._ngZone, this._viewportRuler, s)),
          (this.block = () => new Vi(this._viewportRuler, this._document)),
          (this.reposition = (s) => new Ui(this._scrollDispatcher, this._viewportRuler, this._ngZone, s)),
          (this._document = a);
      }
    };
    (e.ɵfac = function (i) {
      ...
      constructor(t, i, n) {
        super(t),
          ...
          (this._clickListener = (a) => {
            let s = ft(a),
              c = a.type === "click" && this._pointerDownEventTarget ? this._pointerDownEventTarget : s;
      ...
      detach() {
        if (this._isAttached) {
          ...
          t.removeEventListener("pointerdown", this._pointerDownListener, !0),
            ...
            this._platform.IOS && this._cursorStyleIsSet && ((t.style.cursor = this._cursorOriginalValue), (this._cursorStyleIsSet = !1)),
            (this._isAttached = !1);
        }
      }
...
var he = (() => {
    let e = class e {
      ...
      _createContainer() {
        ...
        let i = this._document.createElement("div");
        i.classList.add(t),
          Ze() ? i.setAttribute("platform", "test") : this._platform.isBrowser || i.setAttribute("platform", "server"),
  ...
  Ot = class {
    constructor(e, r, t, i, n, a, s, c, u, l = !1, m) {
      (this._portalOutlet = e),
        ...
        (this._animationsDisabled = l),
        (this._injector = m),
        (this._backdropElement = null),
        (this._backdropClick = new g()),
        (this._attachments = new g()),
        (this._detachments = new g()),
        (this._locationChanges = it.EMPTY),
        ...
        (this._keydownEvents = new g()),
        (this._outsidePointerEvents = new g()),
        (this._renders = new g()),
    ...
    _updateElementSize() {
      ...
      (e.width = U(this._config.width)),
        (e.height = U(this._config.height)),
        (e.minWidth = U(this._config.minWidth)),
        (e.minHeight = U(this._config.minHeight)),
        (e.maxWidth = U(this._config.maxWidth)),
        (e.maxHeight = U(this._config.maxHeight));
    }
  ...
  vo = "cdk-overlay-connected-position-bounding-box",
  _a = /([A-Za-z%]+)$/,
  Yi = class {
    get positions() {
    ...
    constructor(e, r, t, i, n) {
      (this._viewportRuler = r),
        ...
        (this._positionChanges = new g()),
        (this._resizeSubscription = it.EMPTY),
        (this._offsetX = 0),
        (this._offsetY = 0),
    ...
    attach(e) {
      this._overlayRef && this._overlayRef,
        ...
        e.hostElement.classList.add(vo),
        (this._overlayRef = e),
    ...
    apply() {
      ...
      for (let s of this._preferredPositions) {
        let c = this._getOriginPoint(e, i, s),
          u = this._getOverlayPoint(c, r, s),
          l = this._getOverlayFit(u, r, t, s);
        ...
        (!a || a.overlayFit.visibleArea < l.visibleArea) &&
          (a = { overlayFit: l, overlayPoint: u, originPoint: c, position: s, overlayRect: r });
      }
      if (n.length) {
        let s = null,
          c = -1;
    ...
    dispose() {
      this._isDisposed ||
        ...
        this._overlayRef && this._overlayRef.hostElement.classList.remove(vo),
        this.detach(),
    ...
    _getOriginPoint(e, r, t) {
      let i;
      if (t.originX == "center") i = e.left + e.width / 2;
      else {
        let a = this._isRtl() ? e.right : e.left,
      ...
      let n;
      return (
        t.originY == "center" ? (n = e.top + e.height / 2) : (n = t.originY == "top" ? e.top : e.bottom),
        r.top < 0 && (n -= r.top),
        { x: i, y: n }
      );
    }
    ...
    _getOverlayPoint(e, r, t) {
      ...
      let n;
      return (
        t.overlayY == "center" ? (n = -r.height / 2) : (n = t.overlayY == "top" ? 0 : -r.height),
        {
          x: e.x + i,
          y: e.y + n,
        }
    ...
    _getOverlayFit(e, r, t, i) {
      let n = wo(r),
        ...
        u = this._getOffset(i, "y");
      c && (a += c), u && (s += u);
      let l = 0 - a,
        m = a + n.width - t.width,
        D = 0 - s,
        R = s + n.height - t.height,
        B = this._subtractOverflows(n.width, l, m),
        q = this._subtractOverflows(n.height, D, R),
        Vt = B * q;
      return {
        visibleArea: Vt,
    ...
    _canFitWithFlexibleDimensions(e, r, t) {
      if (this._hasFlexibleDimensions) {
        let i = t.bottom - r.y,
          n = t.right - r.x,
          a = yo(this._overlayRef.getConfig().minHeight),
          s = yo(this._overlayRef.getConfig().minWidth),
          c = e.fitsInViewportVertically || (a != null && a <= i),
    ...
    _pushOverlayOnScreen(e, r, t) {
      ...
      let i = wo(r),
        ...
        a = Math.max(e.x + i.width - n.width, 0),
        s = Math.max(e.y + i.height - n.height, 0),
        c = Math.max(n.top - t.top - e.y, 0),
        u = Math.max(n.left - t.left - e.x, 0),
        l = 0,
        m = 0;
      return (
        i.width <= n.width ? (l = u || -a) : (l = e.x < this._viewportMargin ? n.left - t.left - e.x : 0),
        i.height <= n.height ? (m = c || -s) : (m = e.y < this._viewportMargin ? n.top - t.top - e.y : 0),
        (this._previousPushAmount = { x: l, y: m }),
        { x: e.x + l, y: e.y + m }
      );
    }
    ...
    _calculateBoundingBoxRect(e, r) {
      let t = this._viewportRect,
        ...
        a,
        s;
      if (r.overlayY === "top") (a = e.y), (n = t.height - a + this._viewportMargin);
      else if (r.overlayY === "bottom") (s = t.height - e.y + this._viewportMargin * 2), (n = t.height - s + this._viewportMargin);
      else {
        let R = Math.min(t.bottom - e.y + t.top, e.y),
          B = this._lastBoundingBoxSize.height;
        (n = R * 2), (a = e.y - R), n > B && !this._isInitialRender && !this._growAfterOpen && (a = e.y - B / 2);
      }
      let c = (r.overlayX === "start" && !i) || (r.overlayX === "end" && i),
        u = (r.overlayX === "end" && !i) || (r.overlayX === "start" && i),
        l,
        m,
        D;
      if (u) (D = t.width - e.x + this._viewportMargin * 2), (l = e.x - this._viewportMargin);
      else if (c) (m = e.x), (l = t.right - e.x);
      else {
        let R = Math.min(t.right - e.x + t.left, e.x),
          B = this._lastBoundingBoxSize.width;
    ...
    _setBoundingBoxStyles(e, r) {
      ...
      !this._isInitialRender &&
        !this._growAfterOpen &&
        ((t.height = Math.min(t.height, this._lastBoundingBoxSize.height)), (t.width = Math.min(t.width, this._lastBoundingBoxSize.width)));
      let i = {};
    ...
    _setOverlayElementStyles(e, r) {
      ...
      let s = "",
        ...
        u = this._getOffset(r, "y");
      c && (s += `translateX(${c}px) `),
        u && (s += `translateY(${u}px)`),
        (t.transform = s.trim()),
        a.maxHeight && (i ? (t.maxHeight = U(a.maxHeight)) : n && (t.maxHeight = "")),
        a.maxWidth && (i ? (t.maxWidth = U(a.maxWidth)) : n && (t.maxWidth = "")),
        Qt(this._pane.style, t);
    }
...
function va(o, e) {
  return o === e
    ? !0
    : o.isOriginClipped === e.isOriginClipped &&
        o.isOriginOutsideView === e.isOriginOutsideView &&
        o.isOverlayClipped === e.isOverlayClipped &&
        o.isOverlayOutsideView === e.isOverlayOutsideView;
}

var xo = "cdk-global-overlay-wrapper",
  $i = class {
    constructor() {
    ...
    attach(e) {
      ...
      (this._overlayRef = e),
        ...
        e.hostElement.classList.add(xo),
        (this._isDisposed = !1);
    }
    ...
    apply() {
      ...
      let e = this._overlayRef.overlayElement.style,
        ...
        { width: i, height: n, maxWidth: a, maxHeight: s } = t,
        c = (i === "100%" || i === "100vw") && (!a || a === "100%" || a === "100vw"),
        u = (n === "100%" || n === "100vh") && (!s || s === "100%" || s === "100vh"),
        l = this._xPosition,
        m = this._xOffset,
        D = this._overlayRef.getConfig().direction === "rtl",
        R = "",
        B = "",
        q = "";
      c
        ...
        : l === "center"
          ...
          : D
            ? l === "left" || l === "end"
              ? ((q = "flex-end"), (R = m))
              : (l === "right" || l === "start") && ((q = "flex-start"), (B = m))
            : l === "left" || l === "start"
              ? ((q = "flex-start"), (R = m))
              : (l === "right" || l === "end") && ((q = "flex-end"), (B = m)),
        (e.position = this._cssPosition),
        (e.marginLeft = c ? "0" : R),
        (e.marginTop = u ? "0" : this._topOffset),
        (e.marginBottom = this._bottomOffset),
        (e.marginRight = c ? "0" : B),
        (r.justifyContent = q),
        (r.alignItems = u ? "flex-start" : this._alignItems);
    }
    ...
    dispose() {
      ...
      let e = this._overlayRef.overlayElement.style,
        ...
        t = r.style;
      r.classList.remove(xo),
        (t.justifyContent = t.alignItems = e.marginTop = e.marginBottom = e.marginLeft = e.marginRight = e.position = ""),
    ...
    let e = class e {
      constructor(t, i, n, a, s, c, u, l, m, D, R, B) {
        (this.scrollStrategies = t),
          ...
          (this._animationsModuleType = B);
      }

      create(t) {
        let i = this._createHostElement(),
          n = this._createPaneElement(i),
          a = this._createPortalOutlet(n),
          s = new qt(t);
        return (
      ...
      _createPortalOutlet(t) {
        return (
          this._appRef || (this._appRef = this._injector.get(_i)),
          new Ae(t, this._componentFactoryResolver, this._appRef, this._injector, this._document)
        );
      }
    };
    (e.ɵfac = function (i) {
...
var xa = ["mat-menu-item", ""],
  Ca = [[["mat-icon"], ["", "matMenuItemIcon", ""]], "*"],
...
function ka(o, e) {
  ...
  if (o & 2) {
    let r = nt();
    At(r._classList),
      Z("id", r.panelId)("@transformMenu", r._panelAnimationState),
      T("aria-label", r.ariaLabel || null)("aria-labelledby", r.ariaLabelledby || null)("aria-describedby", r.ariaDescribedby || null);
  }
}

var Gi = new v("MAT_MENU_PANEL"),
  Me = (() => {
    let e = class e {
      constructor(t, i, n, a, s) {
        (this._elementRef = t),
      ...
      focus(t, i) {
        this._focusMonitor && t ? this._focusMonitor.focusVia(this._getHostElement(), t, i) : this._getHostElement().focus(i),
      ...
      getLabel() {
        let t = this._elementRef.nativeElement.cloneNode(!0),
      ...
      (e.ɵcmp = b({
        ...
        hostBindings: function (i, n) {
          i & 1 &&
            ...
            i & 2 &&
              (T("role", n.role)("tabindex", n._getTabIndex())("aria-disabled", n.disabled)("disabled", n.disabled || null),
              L("mat-mdc-menu-item-highlighted", n._highlighted)("mat-mdc-menu-item-submenu-trigger", n._triggersSubmenu));
        },
        inputs: {
          role: "role",
          disabled: [2, "disabled", "disabled", G],
        ...
        template: function (i, n) {
          i & 1 && (et(Ca), O(0), p(1, "span", 0), O(2, 1), f(), P(3, "div", 1), K(4, Da, 2, 0, ":svg:svg", 2)),
            i & 2 &&
              (S(3),
              Z("matRippleDisabled", n.disableRipple || n.disabled)("matRippleTrigger", n._getHostElement()),
              S(),
              jt(n._triggersSubmenu ? 4 : -1));
        },
        dependencies: [Ce],
        encapsulation: 2,
        changeDetection: 0,
...
var si = {
    transformMenu: Lt("transformMenu", [
      xt("void", ct({ opacity: 0, transform: "scale(0.8)" })),
      kt("void => enter", It("120ms cubic-bezier(0, 0, 0.2, 1)", ct({ opacity: 1, transform: "scale(1)" }))),
      kt("* => void", It("100ms 25ms linear", ct({ opacity: 0 }))),
    ]),
    fadeInItems: Lt("fadeInItems", [
      xt("showing", ct({ opacity: 1 })),
      kt("void => *", [ct({ opacity: 0 }), It("400ms 100ms cubic-bezier(0.55, 0, 0.55, 0.2)")]),
    ]),
  },
  Ql = si.fadeInItems,
  ql = si.transformMenu,
...
var ue = (() => {
    let e = class e {
      ...
      constructor(t, i, n, a) {
        (this._elementRef = t),
          ...
          (this._directDescendantItems = new Ft()),
          (this._classList = {}),
          (this._panelAnimationState = "void"),
          (this._animationDone = new g()),
          (this.closed = new F()),
          (this.close = this.closed),
          (this.panelId = `mat-menu-panel-${Aa++}`),
          (this._injector = I($)),
      ...
      ngAfterContentInit() {
        this._updateDirectDescendants(),
          (this._keyManager = new Ke(this._directDescendantItems).withWrap().withTypeAhead().withHomeAndEnd()),
          this._keyManager.tabOut.subscribe(() => this.closed.emit("tab")),
          this._directDescendantItems.changes
            .pipe(
              at(this._directDescendantItems),
              Ne((t) => ht(...t.map((i) => i._focused))),
            )
          ...
          this._directDescendantItems.changes.subscribe((t) => {
            ...
            if (this._panelAnimationState === "enter" && i.activeItem?._hasFocus()) {
              let n = t.toArray(),
                a = Math.max(0, Math.min(n.length - 1, i.activeItemIndex || 0));
      ...
      focusFirstItem(t = "program") {
        this._firstItemFocusRef?.destroy(),
          (this._firstItemFocusRef = yt(
            () => {
              let i = null;
              if (
                (this._directDescendantItems.length && (i = this._directDescendantItems.first._getHostElement().closest('[role="menu"]')),
      ...
      setElevation(t) {
        if (this._baseElevation === null) {
          let c =
            (typeof getComputedStyle == "function" ? getComputedStyle(this._elementRef.nativeElement) : null)?.getPropertyValue(
              "--mat-menu-base-elevation-level",
            ) || "8";
          this._baseElevation = parseInt(c);
        }
        let i = Math.min(this._baseElevation + t, 24),
          n = `${this._elevationPrefix}${i}`,
    ...
    (e.ɵfac = function (i) {
      ...
      (e.ɵcmp = b({
        ...
        vars: 0,
        consts: [
          ["tabindex", "-1", "role", "menu", 1, "mat-mdc-menu-panel", "mat-mdc-elevation-specific", 3, "keydown", "click", "id"],
  ...
  let e = class e {
    ...
    constructor(t, i, n, a, s, c, u, l, m) {
      (this._overlay = t),
        ...
        (this._menuItemInstance = c),
        (this._dir = u),
        (this._focusMonitor = l),
        (this._ngZone = m),
        (this._overlayRef = null),
        (this._menuOpen = !1),
        (this._closingActionsSubscription = it.EMPTY),
        (this._hoverSubscription = it.EMPTY),
        (this._menuCloseSubscription = it.EMPTY),
        (this._changeDetectorRef = I(Q)),
        ...
        (this.restoreFocus = !0),
        (this.menuOpened = new F()),
        (this.onMenuOpen = this.menuOpened),
        (this.menuClosed = new F()),
        (this.onMenuClose = this.menuClosed),
        (this._scrollStrategy = a),
        (this._parentMaterialMenu = s instanceof ue ? s : void 0),
        i.nativeElement.addEventListener("touchstart", this._handleTouchStart, Eo);
    }
    ...
    ngOnDestroy() {
      this._overlayRef && (this._overlayRef.dispose(), (this._overlayRef = null)),
        this._element.nativeElement.removeEventListener("touchstart", this._handleTouchStart, Eo),
        this._menuCloseSubscription.unsubscribe(),
    ...
    openMenu() {
      ...
      let i = this._createOverlay(t),
        n = i.getConfig(),
        a = n.positionStrategy;
      this._setPosition(t, a),
        (n.hasBackdrop = t.hasBackdrop == null ? !this.triggersSubmenu() : t.hasBackdrop),
        ...
        t instanceof ue &&
          (t._startAnimation(),
          t._directDescendantItems.changes.pipe(V(t.close)).subscribe(() => {
    ...
    _destroyMenu(t) {
      ...
      this._closingActionsSubscription.unsubscribe(),
        ...
        this.restoreFocus && (t === "keydown" || !this._openedBy || !this.triggersSubmenu()) && this.focus(this._openedBy),
        (this._openedBy = void 0),
        i instanceof ue
          ? (i._resetAnimation(),
            i.lazyContent
              ? i._animationDone
                  .pipe(
                    M((n) => n.toState === "void"),
                    dt(1),
                    V(i.lazyContent._attached),
                  )
                  .subscribe({ next: () => i.lazyContent.detach(), complete: () => this._setIsMenuOpen(!1) })
              : this._setIsMenuOpen(!1))
          : (this._setIsMenuOpen(!1), i?.lazyContent?.detach());
    }

    _initMenu(t) {
      (t.parentMenu = this.triggersSubmenu() ? this._parentMaterialMenu : void 0),
    ...
    _setIsMenuOpen(t) {
      t !== this._menuOpen &&
        ...
        this.triggersSubmenu() && this._menuItemInstance._setHighlighted(t),
        this._changeDetectorRef.markForCheck());
    }
    ...
    _setPosition(t, i) {
      let [n, a] = t.xPosition === "before" ? ["end", "start"] : ["start", "end"],
        [s, c] = t.yPosition === "above" ? ["bottom", "top"] : ["top", "bottom"],
        [u, l] = [s, c],
        [m, D] = [n, a],
        R = 0;
      ...
      i.withPositions([
        { originX: n, originY: u, overlayX: m, overlayY: s, offsetY: R },
        { originX: a, originY: u, overlayX: D, overlayY: s, offsetY: R },
        { originX: n, originY: l, overlayX: m, overlayY: c, offsetY: -R },
        { originX: a, originY: l, overlayX: D, overlayY: c, offsetY: -R },
      ]);
    }

    _menuClosingActions() {
      let t = this._overlayRef.backdropClick(),
    ...
    _handleKeydown(t) {
      ...
      (i === 13 || i === 32) && (this._openedBy = "keyboard"),
        this.triggersSubmenu() &&
          ((i === 39 && this.dir === "ltr") || (i === 37 && this.dir === "rtl")) &&
    ...
    _handleHover() {
      !this.triggersSubmenu() ||
        ...
        (this._hoverSubscription = this._parentMaterialMenu
          ._hovered()
          .pipe(
            M((t) => t === this._menuItemInstance && !t.disabled),
            pi(0, Fe),
          )
          .subscribe(() => {
            (this._openedBy = "mouse"),
              this.menu instanceof ue && this.menu._isAnimating
                ? this.menu._animationDone.pipe(dt(1), pi(0, Fe), V(this._parentMaterialMenu._hovered())).subscribe(() => this.openMenu())
                : this.openMenu();
          }));
    }
    ...
    _getPortal(t) {
      return (
        (!this._portal || this._portal.templateRef !== t.templateRef) && (this._portal = new St(t.templateRef, this._viewContainerRef)),
        this._portal
      );
    }
  };
    ...
    (e.ɵdir = X({
      ...
      hostBindings: function (i, n) {
        i & 1 &&
          ...
          i & 2 &&
            T("aria-haspopup", n.menu ? "menu" : null)("aria-expanded", n.menuOpen)("aria-controls", n.menuOpen ? n.menu.panelId : null);
      },
      inputs: {
...
var ko = (() => {
  class o {
    ...
    static ɵcmp = b({
      ...
      consts: [
        ["menu", "matMenu"],
        [1, "flex", "items-center", "justify-between", "gap-3", "w-full"],
        ["mat-icon-button", "", 3, "click", "matMenuTriggerFor"],
        ["mat-menu-item", ""],
        [1, "p-5"],
      ],
      template: function (t, i) {
        if (t & 1) {
          let n = Nt();
          p(0, "mat-expansion-panel")(1, "mat-expansion-panel-header")(2, "mat-panel-title")(3, "div", 1)(4, "span"),
            C(5),
            f(),
            p(6, "button", 2),
            j("click", function (s) {
            ...
            C(8, "more_vert"),
            f()(),
            p(9, "mat-menu", null, 0)(11, "button", 3)(12, "mat-icon"),
            C(13, "edit"),
            f(),
            p(14, "span"),
            C(15, "Edit"),
            f()(),
            p(16, "button", 3)(17, "mat-icon"),
            C(18, "delete"),
            f(),
            p(19, "span"),
            C(20, "Delete"),
        ...
        if (t & 2) {
          let n,
            a = ze(10);
          wt("background-color", (n = i.projectType.color) !== null && n !== void 0 ? n : "white"),
            S(5),
            bi(" ", i.projectType.title, " "),
            S(),
            Z("matMenuTriggerFor", a),
            S(17),
            Wt(i.projectType == null ? null : i.projectType.description);
        }
      },
...
function Fa(o, e) {
  if ((o & 1 && (Ut(), p(0, "svg", 11), P(1, "circle", 12), f()), o & 2)) {
    let r = nt();
    T("viewBox", r._viewBox()),
      S(),
      wt("stroke-dasharray", r._strokeCircumference(), "px")("stroke-dashoffset", r._strokeCircumference() / 2, "px")(
        "stroke-width",
  ...
  Ao = (() => {
    let e = class e {
      ...
      constructor(t, i, n) {
        (this._elementRef = t),
          ...
          (this._value = 0),
          (this._diameter = So),
          (this._noopAnimations = i === "NoopAnimations" && !!n && !n._forceAnimations),
          (this.mode = t.nativeElement.nodeName.toLowerCase() === "mat-spinner" ? "indeterminate" : "determinate"),
          n &&
            (n.color && (this.color = this._defaultColor = n.color),
            n.diameter && (this.diameter = n.diameter),
            n.strokeWidth && (this.strokeWidth = n.strokeWidth));
      }
    ...
    (e.ɵfac = function (i) {
      ...
      (e.ɵcmp = b({
        ...
        hostBindings: function (i, n) {
          i & 2 &&
            (T("aria-valuemin", 0)("aria-valuemax", 100)("aria-valuenow", n.mode === "determinate" ? n.value : null)("mode", n.mode),
            At("mat-" + n.color),
            wt("width", n.diameter, "px")("height", n.diameter, "px")("--mdc-circular-progress-size", n.diameter + "px")(
              "--mdc-circular-progress-active-indicator-width",
              n.diameter + "px",
            ),
            L("_mat-animation-noopable", n._noopAnimations)("mdc-circular-progress--indeterminate", n.mode === "indeterminate"));
        },
        inputs: {
          color: "color",
          mode: "mode",
        ...
        template: function (i, n) {
          if (
            (i & 1 &&
              (K(0, Fa, 2, 8, "ng-template", null, 0, yn),
              p(2, "div", 2, 1),
              Ut(),
              p(4, "svg", 3),
              P(5, "circle", 4),
            ...
            let a = ze(1);
            S(4),
              T("viewBox", n._viewBox()),
              S(),
              wt("stroke-dasharray", n._strokeCircumference(), "px")("stroke-dashoffset", n._strokeDashOffset(), "px")(
                "stroke-width",
...
var Mo = (() => {
  class o {
    ...
    static ɵcmp = b({
      type: o,
      selectors: [["app-project-type-form"]],
      standalone: !0,
      features: [_],
      decls: 2,
      vars: 0,
      template: function (t, i) {
        t & 1 && (p(0, "p"), C(1, "project-type-form works!"), f());
      },
    });
  }
...
var Ki = (() => {
    let e = class e extends me {
      ...
      _restoreFocus() {
        ...
        if (
          ...
          (!n || n === this._document.body || n === a || a.contains(n)) &&
            (this._focusMonitor
      ...
      _initializeFocusTrap() {
        this._platform.isBrowser &&
          ...
          this._document && (this._elementFocusedBeforeDialogWasOpened = _e()));
      }
    ...
    (e.ɵfac = function (i) {
      ...
      (e.ɵcmp = b({
        ...
        hostBindings: function (i, n) {
          i & 2 &&
            T("id", n._config.id || null)("role", n._config.role)("aria-modal", n._config.ariaModal)(
              "aria-labelledby",
              n._config.ariaLabel ? null : n._ariaLabelledByQueue[0],
            )("aria-label", n._config.ariaLabel)("aria-describedby", n._config.ariaDescribedBy || null);
        },
        standalone: !0,
        features: [st, _],
        decls: 1,
    ...
    let e = class e {
      ...
      constructor(t, i, n, a, s, c) {
        (this._overlay = t),
          ...
          (this._afterAllClosedAtThisLevel = new g()),
          (this._afterOpenedAtThisLevel = new g()),
          (this._ariaHiddenElements = new Map()),
          (this.afterAllClosed = Pe(() =>
            this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe(at(void 0)),
          )),
      ...
      open(t, i) {
        ...
        return (
          (c.containerInstance = u),
          this._attachDialogContent(t, c, u, i),
      ...
      ngOnDestroy() {
        Xi(this._openDialogsAtThisLevel, (t) => {
          ...
          Xi(this._openDialogsAtThisLevel, (t) => t.close()),
      ...
      _attachContainer(t, i, n) {
        let a = n.injector || n.viewContainerRef?.injector,
          s = [
            { provide: Jt, useValue: n },
            { provide: Te, useValue: i },
            { provide: Ot, useValue: t },
          ],
          c;
        n.container
          ? typeof n.container == "function"
            ? (c = n.container)
            : ((c = n.container.type), s.push(...n.container.providers(n)))
          : (c = Ki);
        let u = new le(
          c,
          n.viewContainerRef,
      ...
      _attachDialogContent(t, i, n, a) {
        if (t instanceof Dt) {
          let s = this._createInjector(a, i, n, void 0),
            c = { $implicit: a.data, dialogRef: i };
          a.templateContext && (c = w(w({}, c), typeof a.templateContext == "function" ? a.templateContext() : a.templateContext)),
            n.attachTemplatePortal(new St(t, null, c, s));
        } else {
      ...
      _createInjector(t, i, n, a) {
        let s = t.injector || t.viewContainerRef?.injector,
          c = [
            { provide: Va, useValue: t.data },
            { provide: Te, useValue: i },
          ];
        return (
          t.providers && (typeof t.providers == "function" ? c.push(...t.providers(i, t, n)) : c.push(...t.providers)),
          t.direction &&
            (!s || !s.get(Et, null, { optional: !0 })) &&
            c.push({ provide: Et, useValue: { value: t.direction, change: ot() } }),
        ...
        if (t.parentElement) {
          ...
          for (let n = i.length - 1; n > -1; n--) {
            ...
            a !== t &&
              ...
              (this._ariaHiddenElements.set(a, a.getAttribute("aria-hidden")), a.setAttribute("aria-hidden", "true"));
          }
        }
      }
...
var Re = class {
  ...
  Qi = "mdc-dialog--open",
  Ro = "mdc-dialog--opening",
  Oo = "mdc-dialog--closing",
  Wa = 150,
  Ya = 75,
  $a = (() => {
    let e = class e extends Ki {
      constructor(t, i, n, a, s, c, u, l, m) {
        super(t, i, n, a, s, c, u, m),
          (this._animationMode = l),
          (this._animationStateChanged = new F()),
          (this._animationsEnabled = this._animationMode !== "NoopAnimations"),
          (this._actionSectionCount = 0),
          (this._hostElement = this._elementRef.nativeElement),
          (this._enterAnimationDuration = this._animationsEnabled ? (Po(this._config.enterAnimationDuration) ?? Wa) : 0),
          (this._exitAnimationDuration = this._animationsEnabled ? (Po(this._config.exitAnimationDuration) ?? Ya) : 0),
      ...
      _startOpenAnimation() {
        this._animationStateChanged.emit({ state: "opening", totalTime: this._enterAnimationDuration }),
          this._animationsEnabled
            ? (this._hostElement.style.setProperty(Fo, `${this._enterAnimationDuration}ms`),
              this._requestAnimationFrame(() => this._hostElement.classList.add(Ro, Qi)),
              this._waitForAnimationToComplete(this._enterAnimationDuration, this._finishDialogOpen))
            : (this._hostElement.classList.add(Qi), Promise.resolve().then(() => this._finishDialogOpen()));
      }
      ...
      _startExitAnimation() {
        this._animationStateChanged.emit({ state: "closing", totalTime: this._exitAnimationDuration }),
          ...
          this._animationsEnabled
            ? (this._hostElement.style.setProperty(Fo, `${this._exitAnimationDuration}ms`),
              this._requestAnimationFrame(() => this._hostElement.classList.add(Oo)),
    ...
    (e.ɵfac = function (i) {
      ...
      (e.ɵcmp = b({
        ...
        hostBindings: function (i, n) {
          i & 2 &&
            (gi("id", n._config.id),
            T("aria-modal", n._config.ariaModal)("role", n._config.role)(
              "aria-labelledby",
              n._config.ariaLabel ? null : n._ariaLabelledByQueue[0],
            )("aria-label", n._config.ariaLabel)("aria-describedby", n._config.ariaDescribedBy || null),
            L("_mat-animation-noopable", !n._animationsEnabled)("mat-mdc-dialog-container-with-actions", n._actionSectionCount > 0));
        },
        standalone: !0,
        features: [st, _],
        decls: 3,
...
function Po(o) {
  return o == null
    ...
    : typeof o == "number"
      ? o
      : o.endsWith("ms")
        ? re(o.substring(0, o.length - 2))
        : o.endsWith("s")
          ? re(o.substring(0, o.length - 1)) * 1e3
          : o === "0"
            ? 0
            : null;
}
  ...
  Oe = class {
    constructor(e, r, t) {
      (this._ref = e),
        ...
        (this._afterOpened = new g()),
        (this._beforeClosed = new g()),
        (this._state = ci.OPEN),
        (this.disableClose = r.disableClose),
        (this.id = e.id),
        ...
        this._containerInstance._animationStateChanged
          ...
          .subscribe((r) => {
            this._beforeClosed.next(e),
              ...
              (this._closeFallbackTimeout = setTimeout(() => this._finishDialogClose(), r.totalTime + 100));
          }),
        (this._state = ci.CLOSING),
    ...
    updatePosition(e) {
      ...
      return (
        e && (e.left || e.right) ? (e.left ? r.left(e.left) : r.right(e.right)) : r.centerHorizontally(),
        e && (e.top || e.bottom) ? (e.top ? r.top(e.top) : r.bottom(e.bottom)) : r.centerVertically(),
...
var qi = new v("MatMdcDialogData"),
  Ga = new v("mat-mdc-dialog-default-options"),
    ...
    let e = class e {
      ...
      constructor(t, i, n, a, s, c, u, l) {
        (this._overlay = t),
          ...
          (this._afterAllClosedAtThisLevel = new g()),
          (this._afterOpenedAtThisLevel = new g()),
          (this.dialogConfigClass = Re),
          (this.afterAllClosed = Pe(() =>
            this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe(at(void 0)),
          )),
          (this._dialog = i.get(To)),
          (this._dialogRefConstructor = Oe),
          (this._dialogContainerType = $a),
          (this._dialogDataToken = qi);
      }

      open(t, i) {
        let n;
        (i = w(w({}, this._defaultOptions || new Re()), i)),
          (i.id = i.id || `mat-mdc-dialog-${Ka++}`),
          ...
          zt(w({}, i), {
            ...
            container: {
              ...
              providers: () => [
                ...
                { provide: Jt, useValue: i },
              ],
            },
            templateContext: () => ({ dialogRef: n }),
            providers: (s, c, u) => (
              (n = new this._dialogRefConstructor(s, i, u)),
              n.updatePosition(i?.position),
              [
        ...
        return (
          ...
          (n.componentInstance = a.componentInstance),
  ...
  class o {
    ...
    static ɵcmp = b({
      ...
      consts: [
        ...
        [1, "text-3xl", "!m-0"],
        [1, "p-5"],
        [1, "p-5", "border-t", "flex", "justify-end", "gap-5"],
        ["mat-flat-button", "", "color", "warn", 3, "click"],
        ["mat-flat-button", "", 3, "click"],
      ],
      template: function (t, i) {
        if (
          (t & 1 &&
            (p(0, "div", 0)(1, "div", 1)(2, "p", 2),
            C(3),
            f()(),
            p(4, "div", 3)(5, "p"),
            C(6),
            f()(),
            p(7, "div", 4)(8, "button", 5),
            j("click", function () {
              return i.confirm();
            }),
            C(9),
          ...
          let n, a, s, c;
          S(3),
            Wt((n = i.data.title) !== null && n !== void 0 ? n : "Confirmare"),
            S(3),
            Wt(
              (a = i.data.message) !== null && a !== void 0
                ? a
                : "Sunte\u021Bi sigur c\u0103 dori\u021Bi s\u0103 efectua\u021Bi ac\u021Biunea?",
            ),
            S(3),
            Wt((s = i.data.confirmButtonText) !== null && s !== void 0 ? s : "Da"),
            S(2),
            Wt((c = i.data.cancelButtonText) !== null && c !== void 0 ? c : "Nu");
        }
      },
      dependencies: [ce],
    });
...
var No = (() => {
  class o {
    ...
    static ɵcmp = b({
      type: o,
      selectors: [["app-create-project-type-dialog"]],
      standalone: !0,
      features: [_],
      decls: 11,
      vars: 0,
      ...
      template: function (t, i) {
        t & 1 &&
          ...
          f()(),
          p(4, "div", 3),
          P(5, "app-project-type-form"),
          f(),
          p(6, "div", 4)(7, "button", 5),
          C(8, "Salveaz\u0103"),
          f(),
          p(9, "button", 6),
          j("click", function () {
...
function Ja(o, e) {
  if ((o & 1 && P(0, "app-project-type", 12), o & 2)) {
    let r = e.$implicit;
    Z("projectType", r);
  }
}
...
function ts(o, e) {
  if ((o & 1 && (p(0, "div", 10), K(1, Ja, 1, 1, "app-project-type", 11), f()), o & 2)) {
    let r = nt();
...
var zo = (() => {
  class o {
    ...
    getIssueTypes() {
      (this.isLoading = !0),
        this.projectTypeController.getIssueTypes().subscribe({
          next: (r) => {
    ...
    static ɵcmp = b({
      ...
      consts: [
        [1, "h-full", "w-full", "p-5"],
        [1, "flex", "flex-col", "h-full", "max-w-[1200px]", "mx-auto"],
        [1, "flex", "justify-between", "items-center"],
        [1, "text-3xl", "font-bold"],
        [1, "flex", "gap-5", "items-center"],
        ["mat-flat-button", "", "color", "primary", 3, "click"],
        [1, "ml-2"],
        [1, "flex-grow"],
        ["class", "flex flex-col gap-5", 4, "ngIf"],
        ["class", "w-full h-full flex items-center justify-center", 4, "ngIf"],
        [1, "flex", "flex-col", "gap-5"],
        [3, "projectType", 4, "ngFor", "ngForOf"],
        [3, "projectType"],
        [1, "w-full", "h-full", "flex", "items-center", "justify-center"],
        [3, "diameter"],
      ],
      template: function (t, i) {
        t & 1 &&
          (p(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "h1", 3),
          C(4, "Proiecte"),
          f(),
          p(5, "div", 4)(6, "button", 5),
          j("click", function () {
          ...
          f()()()(),
          p(10, "div", 7),
          K(11, ts, 2, 1, "div", 8)(12, es, 2, 1, "div", 9),
          f()()()),
          t & 2 && (S(11), Z("ngIf", !i.isLoading), S(), Z("ngIf", i.isLoading));
      },
